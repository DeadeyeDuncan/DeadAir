...
/// <summary>
/// Pure math for the nebula pill scope
/// (docs/superpowers/specs/2026-07-17-nebula-scope-skin-design.md).
/// Ignition/retract timing carried from DeadEye; retract is deliberately 450 ms
/// (not DeadEye's 4.8 s) so the pill leaves fast.
/// </summary>
public static class ScopeGeometry
{
    public const double IgnitionMs = 300.0;   // DeadEye hopMs
